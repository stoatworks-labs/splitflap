...
**[v0.1.0](https://github.com/stoatworks-labs/splitflap/releases/tag/v0.1.0)** — prebuilt for macOS and Windows. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`splitflap-0.1.0-macos-universal.dmg`](https://github.com/stoatworks-labs/splitflap/releases/download/v0.1.0/splitflap-0.1.0-macos-universal.dmg) | 236 KB |
| Universal (Apple Silicon + Intel) · .zip archive | [`splitflap-macos-universal.zip`](https://github.com/stoatworks-labs/splitflap/releases/latest/download/splitflap-macos-universal.zip) | 195 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`splitflap-0.1.0-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/splitflap/releases/download/v0.1.0/splitflap-0.1.0-windows-x86_64-setup.exe) | 229 KB |
| x64 · .zip archive | [`splitflap-windows-x86_64.zip`](https://github.com/stoatworks-labs/splitflap/releases/latest/download/splitflap-windows-x86_64.zip) | 123 KB |

</details>

All builds, checksums and release notes: [github.com/stoatworks-labs/splitflap/releases](https://github.com/stoatworks-labs/splitflap/releases).
